...
| Status | Dormant (holds IP assets only) |
| Directors | Rieko Vining, Thomas Vining |
...
- **Class 16:** Books, printed matter, illustrations
- **Class 20:** Decorative objects, figurines (non-toy)
- **Class 41:** Entertainment, exhibitions, publishing, music services
...
An attempt to add Classes 25, 28, 35 via TM3A form (~23 February 2026, £150) was declined. TM3A only allows transfer of goods between existing classes, not addition of new classes. Fee refunded. This led to the Batch 2 filing above.

### Ownership Transfer (TM16)
...
| Filed | 16 April 2026 |
| Registry | UK IPO |
| Classes | 20 (decorative objects), 28 (toys) |
| Cost | £265 |
...
Filed as standard black-on-white (not colour-specific) following the KAWS precedent, allowing enforcement in any colour variant. Single application for the full character with arms. Simplified "without arms" version deferred unless needed later.
...
**Formal registration (not pursued):** UK IPO £30, US Copyright Office $65, Chinese registration £100-200. All deferred given the volume of dated evidence already held.

Copyright protects the specific artwork (stops exact copying). Trademark (design mark) protects the character shape as brand identifier (stops commercial use of similar shapes). Both needed for full protection.
...
The first license (14 February 2026, personal to More Air) is superseded by the structure above. Archived in `trademark/1 license/_archive/`.
...
| Domain | Purpose |
|--------|---------|
| auwa.life | Primary (brand home, website) |
| auwalife.com | Redirect to auwa.life |
| auwa.app | App (Kokoro Mirror) |
| auwaapp.com | Redirect to auwa.app |
| auwa.world | Story/brand universe |
| auwaworld.com | Redirect |
| auwa.store | Shop |
| auwastore.com | Redirect |
| auwa.co.uk | UK legal protection |
| auwa.uk | UK legal protection |

**Registrar:** UK2.net (consistent with More Air domains).
**Email:** hello@auwa.life (configured), plus platform-specific aliases.
**Not available:** auwa.art.
**Pre-existing:** auwaworld.com (registered ~2017).
...
| 27 Feb 2026 | Word mark Batch 1 examination complete |
...
- **Standard black-on-white design marks** allow enforcement in any colour (KAWS precedent).
...
All original documents stored in Dropbox:

```
Dropbox/3 venture/auwa/admin/
├── corporation/                         — Company incorporation documents
├── trademark/
│   ├── 1 license/
...
│   │   │   └── batch 2/                 — Additional 3-class filing (16 Apr 2026)
│   │   ├── exclusions/
...
│       ├── evidence/                    — Creation date evidence (2016-2020)
│       └── search/                      — WIPO + Google search results
├── costing/                             — Financial planning
├── domains/                             — Domain registration records
└── office/                              — Virtual office details
```
