...
7. Run `/journal:article`. It reads from `2-edited/`, generates the 1800px web versions to `website/main/public/journal/{slug}/`, the 1080×1350 IG versions to the shared Dropbox `social` folder under `3-journal/{slug}/` (see AUWA_SOCIAL_ROOT), and the 1200×630 OG image alongside the web hero.
