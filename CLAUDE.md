...
- `context/brand.md` — Brand guidelines: logo/wordmark specs, typography system (Cormorant + Instrument Sans + Noto Sans JP), colour system (OKLCH cosmic palette + emotional state colours), photography direction, illustration integration, social content templates, motion principles, cross-site consistency (auwa.life subpaths).
...
- `context/website.md` — Website specification for auwa.life: Kinfolk-inspired editorial site structure, page layouts, Sanity CMS content model, responsive design, serif typography, motion principles, v0/Stitch prompt ideas, reference websites, article preparation plan.
