...
export const metadata: Metadata = {
  ...
  description:
    "A Japanese lifestyle brand rooted in the ancient belief that a life force, or Kokoro, resides in all things. Illustrated stories and figures made by hand.",
  ...
  twitter: {
    ...
    title: "Auwa | Japanese Philosophy of Kokoro",
    description: "Japanese lifestyle brand rooted in the belief that a life force, or Kokoro, resides in all things.",
    images: ["/og-image.jpg"],
  },
};
