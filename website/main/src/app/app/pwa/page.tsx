...
/*
  ...
  On mount, redirects to /app/pwa/welcome if the user has not yet
...
import { DailyLightCapture } from "@/components/app/daily-light-capture";
import { QuietEntries } from "@/components/app/quiet-entries";
import {
  getYamatoState,
  type YamatoState,
  type SubExpression,
