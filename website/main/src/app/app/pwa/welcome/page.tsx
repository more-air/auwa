...
/*
  ...
  The remaining three phases live in /app/pwa/page.tsx where the user
  arrives next:
  ...
  full daily flow — the route change from /app/pwa/welcome → /app/pwa
  is invisible (both cosmic surfaces) and step 9 just is the daily
  flow rendering naturally.
...
import { PlaceholderAsset } from "@/components/app/placeholder-asset";
...
export default function Welcome() {
  ...
  // If the user has already finished welcome, skip them to /app/pwa.
