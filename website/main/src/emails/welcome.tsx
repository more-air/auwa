...
const sourceContent = {
  newsletter: {
    ...
    heading: "Meet Auwa.",
    body: [
      "Thank you for joining us. Auwa is a character and the philosophy it carries. Since ancient times, the Japanese have believed a life force resides in all things, and in Auwa we call it Kokoro (心). We'll write now and then from that world, with notes on Japanese craft and seasonal living, and early word when there's real news, the first book and the first figures.",
  ...
  "book-waitlist": {
    ...
    imageAlt: "Auwa: The Dawn illustrated book",
    cta: "Follow on Instagram",
    ctaUrl: INSTAGRAM_URL,
  },
};
