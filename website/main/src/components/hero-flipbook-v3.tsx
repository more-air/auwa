...
/*
  Stacked-card flipbook inspired by Obsidian Assembly.
  Cards are centred portrait images that stack/unstack on scroll.
  Text is positioned left and right of the card, changing per slide.
*/
...
const CARDS: {
  landscape: string;
  portrait: string;
  label: string; // small uppercase label (left side)
  heading: string; // main text (right side)
  sub?: string; // optional second line
  pillar: string; // which AUWA pillar this represents
}[] = [
  {
    landscape: "/hero/frames/landscape/01.jpg",
    portrait: "/hero/frames/portrait/01.jpg",
    label: "The Character",
    heading: "Everything has Kokoro.",
    pillar: "AUWA",
  },
  {
    landscape: "/hero/frames/landscape/02.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/03.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/04.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/05.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/06.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/07.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/08.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/09.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/10.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/11.jpg",
  ...
  {
    landscape: "/hero/frames/landscape/12.jpg",
...
export function HeroFlipbookV3() {
  ...
  useEffect(() => {
    CARDS.forEach((card) => {
      ...
      img1.src = card.landscape;
      const img2 = new Image();
      img2.src = card.portrait;
    });
  }, []);
  ...
  const handleScroll = useCallback(() => {
    ...
    // Calculate sequence order for each card (distance from active)
  ...
  return (
    ...
    >
      <div className="sticky top-0 z-10 h-screen w-full overflow-hidden bg-white">
        {/* Main layout: text left, card centre, text right */}
        <div className="relative h-full w-full flex items-center justify-center">
          ...
          <div className="hidden md:flex absolute left-8 lg:left-20 top-1/2 -translate-y-1/2 flex-col items-start gap-6 w-[200px] lg:w-[240px]">
            ...
            <div className="absolute top-24 left-0">
              <div className="flex items-baseline gap-1">
                ...
                <span className="font-sans text-[11px] text-void/20">
                  {CARD_COUNT}
                </span>
              </div>
            </div>
          ...
          <div className="relative" style={{ width: "min(55vh, 44vw)", height: "min(72vh, 58vw)" }}>
            ...
            {CARDS.map((card, i) => {
              ...
              const translateY = order * 3.5; // vh units
              ...
              return (
                <a
                  key={`card-${i}`}
                  href={href}
                  className={`hidden md:block absolute inset-0 rounded-xl overflow-hidden group ${
                  ...
                  style={{
                    ...
                    zIndex,
                    opacity,
                    transition: "transform 0.8s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.6s ease-out, box-shadow 0.4s ease-out",
                    boxShadow: isActive
                      ? undefined
                ...
                >
                  ...
                  />
                  {/* Subtle hover overlay: faint light wash */}
            ...
            {CARDS.map((card, i) => {
              ...
              return (
                <a
                  key={`mcard-${i}`}
                  href={href}
                  className={`md:hidden absolute inset-0 rounded-xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.08)] active:scale-[0.98] transition-transform duration-200 ${
          ...
          {/* ── Desktop progress bar (bottom centre) ── */}
          <div className="hidden md:flex absolute bottom-8 left-1/2 -translate-x-1/2 items-center gap-3 z-20">
            <div className="w-24 h-[1px] bg-void/8 overflow-hidden">
              <div
                ...
                style={{
                  width: `${((activeIndex + 1) / CARD_COUNT) * 100}%`,
                }}
              />
            </div>
          </div>
            ...
            {CARDS.map((_, i) => (
              <div
                ...
                className={`rounded-full transition-all duration-300 ${
                  i === activeIndex
                    ? "w-3 h-[2px] bg-void/40"
                    : "w-[3px] h-[2px] bg-void/15"
                }`}
              />
            ))}
          </div>
