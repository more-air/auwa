...
export function Footer() {
  return (
    <footer className="border-t border-void/8">
      {/* Category links */}
      <div className="px-6 md:px-12 lg:px-20 xl:px-28 py-16 md:py-20">
      ...
      <div className="border-t border-void/8">
        <div className="px-6 md:px-12 lg:px-20 xl:px-28 py-6 flex items-center justify-between">
          <p className="font-sans text-[12px] tracking-[0.02em] text-void/40">
          ...
          <div className="flex items-center gap-5">
            {socialLinks.map((link) => (
              <a
                ...
                className="text-void/40 hover:text-void transition-colors duration-300"
              >
                {link.icon}
              </a>
            ))}
